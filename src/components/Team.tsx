    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {contributors.map(({ imageUrl, name, role, githubUrl }: ContributorProps) => (
            <div key={name} className="group flex flex-col items-center text-center pb-8">
              ...
              <div className="relative z-10 w-full">
                ...
                <p className="text-sm text-zinc-500 mt-1 font-light">{role}</p>
        ...
        <div className="mt-12 text-center">
          ...
          <a href="#community" className="text-[#10b981] font-semibold hover:underline">
