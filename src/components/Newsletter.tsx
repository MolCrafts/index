...
export const Newsletter = () => {
  ...
  return (
    <section id="newsletter" className="py-16 md:py-20 relative overflow-hidden">
      <div className="container mx-auto px-4 lg:px-8 max-w-5xl relative z-10">
        ...
        >
          <div className="grid md:grid-cols-2 md:items-end gap-6">
            ...
            <motion.div
              variants={slideUp}
              className="flex items-center gap-4 shrink-0 md:justify-self-end"
            >
              <div
