...
export const Impact = () => {
  return (
    <section id="impact" className="container py-24 sm:py-32 relative text-center">
      ...
      >
        <motion.div variants={slideUp} className="mb-8">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Building the Runway for <span className="gradient-text-secondary">Discovery.</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            We are not just building tools; we are creating the infrastructure that allows
            researchers to focus entirely on discovery. This is the open foundation tailored for the
            incoming wave of generative chemistry, material design, and sustainable innovation.
          </p>
        </motion.div>
