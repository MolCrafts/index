...
export const CollaborationIcon: FC<IconProps> = ({ className }) => (
	...
	>
		...
		<path
			d="M7 8V9C7 10.1046 7.89543 11 9 11H15C16.1046 11 17 10.1046 17 9V8"
			stroke="currentColor"
			strokeWidth="1.5"
		/>
...
export const IntegrationIcon: FC<IconProps> = ({ className }) => (
	...
	>
		...
		<path
			d="M14 3H5C3.89543 3 3 3.89543 3 5V19C3 20.1046 3.89543 21 5 21H19C20.1046 21 21 20.1046 21 19V10"
			stroke="currentColor"
			strokeWidth="1.5"
			strokeLinecap="round"
		/>
