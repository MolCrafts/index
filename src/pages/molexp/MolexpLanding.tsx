			...
			>
				...
				>
					<motion.header className="flex flex-col items-center justify-center w-full">
						...
						>
							Workflow. Agents. Assets.
						</motion.h3>

						<motion.h1
							className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-[7rem] font-sans font-extrabold text-center mx-auto tracking-tighter leading-[1.1] w-full mb-4 sm:mb-6 pb-4 bg-gradient-to-r from-indigo-500 via-blue-400 to-indigo-500 bg-[length:200%_auto] animate-gradient-x text-transparent bg-clip-text pt-2"
				...
				>
					...
					>
						<motion.h2
							...
							transition={{ delay: 0.3, duration: 0.4 }}
						>
							What the <span className="bg-gradient-to-r from-indigo-400 to-blue-400 text-transparent bg-clip-text leading-relaxed">API</span> Feels Like
						</motion.h2>
						<p className="text-zinc-400 text-base md:text-lg leading-relaxed font-light">
							These examples mirror the README directly: task-graph execution,
							reproducible Project-Experiment-Run workspaces, and agent-aware
							...
							<div className="flex flex-col gap-10 relative">
								{API_SNIPPETS.map((cap, idx) => (
									...
									>
										...
										<div
											className={`mb-2 transition-colors duration-300 ${activeCodeIdx === idx ? "text-indigo-400" : "text-zinc-500 group-hover:text-zinc-300"}`}
										>
				...
				>
					<motion.div className="text-center mb-20" variants={slideUp}>
						<motion.h2
							...
							transition={{ delay: 0.3, duration: 0.4 }}
						>
							What MolExp <span className="bg-gradient-to-r from-indigo-400 to-blue-400 text-transparent bg-clip-text leading-relaxed">Covers</span>
						</motion.h2>
						<p className="text-zinc-400 text-base md:text-lg leading-relaxed font-light max-w-4xl mx-auto">
							The API above illustrates the workflow composition block. The features below explain how MolExp manages stateful datasets, runs, and artifacts.
						</p>
					</motion.div>
					...
					>
						{FEATURES.map((feature) => (
							<motion.div
								...
								variants={slideUp}
							>
								<div className="text-indigo-500 mb-6 group-hover:text-indigo-400 transition-colors">
									{feature.icon}
								</div>
