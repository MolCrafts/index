			...
			>
				...
				>
					<motion.header className="flex flex-col items-center justify-center w-full">
						<motion.h3
							className="text-2xl sm:text-3xl md:text-4xl bg-gradient-to-r from-emerald-400 via-teal-400 to-emerald-400 bg-[length:200%_auto] animate-gradient-x text-transparent bg-clip-text font-['Playfair_Display',serif] italic font-medium mb-4 sm:mb-6 pb-2"
							initial={{ opacity: 0, y: -10 }}
							animate={{ opacity: 1, y: 0 }}
							transition={{ delay: 0.1, duration: 0.4 }}
						>
							Zero-Dependency. Layered. Type-Safe.
						</motion.h3>
					...
					>
						<motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
							<a
								href="#toolkit"
								className="flex items-center justify-center w-full sm:w-auto text-base sm:text-lg px-8 py-3 font-semibold rounded-md bg-emerald-500 text-zinc-950 outline outline-1 outline-emerald-500 outline-offset-[3px] transition-all hover:bg-emerald-400 shadow-[0_0_15px_rgba(16,185,129,0.3)]"
							>
								See the API
							</a>
						</motion.div>
						...
						<motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
							<a
								...
								href="https://github.com/MolCrafts/molcfg"
								target="_blank"
								className="flex items-center justify-center w-full sm:w-auto text-base sm:text-lg px-8 py-3 font-semibold rounded-md bg-[#0a0a0a] text-white outline outline-1 outline-emerald-500 outline-offset-[3px] border border-zinc-800 transition-all hover:bg-zinc-900 shadow-[0_0_15px_rgba(16,185,129,0.1)]"
				...
				>
					...
					>
						<motion.h2
							...
							transition={{ delay: 0.3, duration: 0.4 }}
						>
							What the <span className="bg-gradient-to-r from-emerald-400 to-teal-400 text-transparent bg-clip-text leading-relaxed">API</span> Feels Like
						</motion.h2>
						<p className="text-zinc-400 text-base md:text-lg leading-relaxed font-light">
							The examples here follow the README directly: layered loading,
							source tracking, interpolation, schema validation, and immutable
							merge behavior without runtime dependencies.
						</p>
					</motion.div>
				...
				>
					<motion.div className="text-center mb-20" variants={slideUp}>
						<motion.h2
							...
							transition={{ delay: 0.3, duration: 0.4 }}
						>
							What MolCfg <span className="bg-gradient-to-r from-emerald-400 to-teal-400 text-transparent bg-clip-text leading-relaxed">Covers</span>
						</motion.h2>
						<p className="text-zinc-400 text-base md:text-lg leading-relaxed font-light max-w-4xl mx-auto">
							...
							below show how the package is designed to handle every edge case 
							when dealing with configurations in your python package.
						</p>
					</motion.div>
